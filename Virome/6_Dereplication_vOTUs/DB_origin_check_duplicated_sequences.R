...
viral_DB_origin[,"DB"] [grep("^[AD].*NODE", viral_DB_origin$viral_seq)] <- "CS" # 2,950
...
deduplicated_viral_DB_origin$new_viral_ID <- ifelse(grepl("/", deduplicated_viral_DB_origin$viral_seq) & grepl("^[AD].*NODE", deduplicated_viral_DB_origin$viral_seq),
